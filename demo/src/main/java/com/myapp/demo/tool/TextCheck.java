...
public class TextCheck {
    ...
    private static final String accessKeyId = "LTAIAlpJwaj1JQJY"; //TODO: 这里要写成你自己生成的
    private static final String accessKeySecret = "4a7k2tQ8SVGYbJLTFesaNqmzJxAHkl";//TODO: 这里要写成你自己生成的
